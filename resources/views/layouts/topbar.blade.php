        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ url('index') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ URL::asset('/assets/images/rubik.png') }}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ URL::asset('/assets/images/zysd.png') }}" alt="" height="20">
                    </span>
                </a>
                ...
                <a href="{{ url('index') }}" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ URL::asset('/assets/images/zys.png') }}" alt="" height="20">
                    </span>
                </a>
            </div>
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item"
                        onclick="event.preventDefault(); document.getElementById('logout-form').submit();">z<i
                            class="uil uil-sign-out-alt font-size-18 align-middle me-1 text-muted"></i> <span
                            class="align-middle">Desconectarse</span></a>
